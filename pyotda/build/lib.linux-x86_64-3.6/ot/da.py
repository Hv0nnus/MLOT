...
def sinkhorn_ML(Xs, ys, Xt, a, labels_a, b, M, mini_batch_size, reg_e, type_reg, reg_cl=0.1, reg_l=1., numItermax=10,
...
class SinkhornMLTransport(BaseTransport):
    ...
    def __init__(self, reg_e=1., reg_cl=0.1, reg_l=1., type_reg="l1",
                 max_iter=10,
